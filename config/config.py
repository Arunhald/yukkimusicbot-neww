...
BOT_TOKEN = getenv("BOT_TOKEN", "2144094143:AAEYpoRBZ5k6RUIGA13i4IzMMOesT94ioPQ")
...
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", "-1001645899463"))

# A name for your Music bot.
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME","TQ")
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Arunhald/YukkiMusicBot-new",
)
...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL","https://t.me/smart_aruney_bots"
)  # Example:- https://t.me/TheYukki
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/Tessa_Queen_supports"
